using UnityEngine;
using UnityEngine.UI; // 引入 UI 的命名空间
...
public class TribeSelectionUI : MonoBehaviour
{
	...
	[SerializeField] private Text[] tribeNameTexts = new Text[3];  // 显示部族名称（改为 Text 类型）
	[SerializeField] private Text[] tribeDescriptionTexts = new Text[3]; // 显示能力描述（改为 Text 类型）
	[SerializeField] private Button confirmButton;
	[SerializeField] private Text selectedTribeText; // 改为 Text 类型
